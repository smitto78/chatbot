...
def render_output_with_watermark(content: str) -> None:
    ...
    st.markdown(
        "<div style='margin-top:8px'><sub>© 2025 Tommy Smith — NFHS Football Rules Assistant</sub></div>","<div style='margin-top:8px'><sub>ChatGPT can make mistakes. Check important info.</sub></div>"
        unsafe_allow_html=True
    )
