...
# Clear logic
if "clear_general_prompt" in st.session_state:
    del st.session_state["general_prompt"]
    del st.session_state["clear_general_prompt"]
...
if general_prompt and general_submit:
    ...
    st.session_state["clear_general_prompt"] = True
    st.session_state["latest_general_reply"] = general_reply
    st.experimental_rerun()

# Display assistant reply if available after rerun
if "latest_general_reply" in st.session_state:
    with st.chat_message("assistant"):
        display_assistant_reply(st.session_state["latest_general_reply"])
    del st.session_state["latest_general_reply"]
...
# Clear logic
if "clear_rule_input" in st.session_state:
    del st.session_state["rule_input"]
    del st.session_state["clear_rule_input"]
...
if rule_id_input and rule_submit:
    ...
    st.session_state["clear_rule_input"] = True
    st.session_state["latest_rule_reply"] = rule_reply
    st.experimental_rerun()

# Display assistant reply if available after rerun
if "latest_rule_reply" in st.session_state:
    with st.chat_message("assistant"):
        display_assistant_reply(st.session_state["latest_rule_reply"])
    del st.session_state["latest_rule_reply"]
